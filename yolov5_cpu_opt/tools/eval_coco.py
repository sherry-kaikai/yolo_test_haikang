...
def argsparser():
    ...
    parser.add_argument('--result_json', type=str, default='/workingspace/13_yolo_and_vlpr_test/yolov5_cpu_opt/python/TPUID0 process1_results.json', help='path of result json')
